        ...
        IRequestHandler<CancelarProcessamentoPedidoCommand, bool>
    {
        ...
        public async Task<bool> Handle(AdicionarItemPedidoCommand message, CancellationToken cancellationToken)
        {
            ...
            if(pedido== null)
            {
                ...
                pedido.AdicionarEvento(new PedidoRascunhoIniciadoEvent(message.ClienteId, pedido.Id)); //Adicionamos um evento na lista em memória que sera concretizado ao final da transação
            }
            else
            {
        ...
        public async Task<bool> Handle(AtualizarItemPedidoCommand message, CancellationToken cancellationToken)
        {
            ...
            _pedidoRepository.Atualizar(pedido); //desnecessário pois o changetracker já faz isso, mas é bom para mostar a inteção do que será feito.
        ...
        public async Task<bool> Handle(RemoverItemPedidoCommand message, CancellationToken cancellationToken)
        {
            ...
            pedido.RemoverItem(pedidoItem); //sempre orquestrar as ações pelo aggregate root
        ...
        public async Task<bool> Handle(AplicarVoucherPedidoCommand message, CancellationToken cancellationToken)
        {
            ...
            //reforçando conceito de aggregate root onde não manipulamos a classe filha e sim a classe de agregação
        ...
        public async Task<bool> Handle(IniciarPedidoCommand message, CancellationToken cancellationToken)
        {
            ...
            var listaProdutosPedido = new ListaProdutosPedidos { PedidoId = pedido.Id, Itens = itensList };
        ...
        public async Task<bool> Handle(CancelarProcessamentoPedidoEstornarEstoqueCommand message, CancellationToken cancellationToken)
        {
            ...
            pedido.AdicionarEvento(new PedidoProcessamentoCanceladoEvent(pedido.Id, pedido.ClienteId, listaProdutosPedido)); //evento de integração para poder devolver os produtos ao estoque
        ...
        private bool ValidarComando(Command message)
        {
            ...
            {
                // message.MessageType = é a classe onde está ocorrendo a mensagem neste caso PedidoCommandHandler
