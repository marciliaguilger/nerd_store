...
namespace NerdStore.Vendas.Domain
{
    public class Pedido : Entity, IAggregateRoot
    {
        ...
        private readonly List<PedidoItem> _pedidoItems; //lista interna para manipulação dentro da classe
        public IReadOnlyCollection<PedidoItem> PedidoItems => _pedidoItems; //lista public para somente de leitura
        ...
        public static class PedidoFactory
        {
            ...
            public static Pedido NovoPedidoRascunho(Guid clienteId)
            {
                ...
                //por se tratar de uma classe aninhada temos acesso ao construtor protected
