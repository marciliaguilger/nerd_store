...
namespace NerdStore.WebApp.MVC.Setup
{
    public static class DependencyInjection
    {
        public static void RegisterServices(this IServiceCollection services)
        {
            ...
            // poderia ser feito na infra dependendo do caso
            ...
            //catalogo events
            // "quem" irá resolver o evento da determinada interface (INOtificationHandler)
            ...
            services.AddScoped<INotificationHandler<PedidoEstoqueConfirmadoEvent>,PagamentoEventHandler>(); //gatilho para o pagamento
        }
